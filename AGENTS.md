...
- Home UX rule: `/app` must default to `개인 워크스페이스 / AI 일정 도우미`. The top of the home screen should only let users switch between `개인` and `업무` workspaces; travel, study, fitness, and plan categories should stay out of the home screen.

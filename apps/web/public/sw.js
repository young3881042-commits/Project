const CACHE_NAME = 'orbit-web-v70';
...
self.addEventListener('fetch', (event) => {
  ...
  if (url.origin !== self.location.origin || hasPathPrefix(url.pathname, '/orbit-chat-attachment') || hasPathPrefix(url.pathname, '/orbit-workspace') || hasPathPrefix(url.pathname, '/api') || hasPathPrefix(url.pathname, '/ws')) return;

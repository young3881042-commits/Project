...
final class VerifiedLocalPlaceCatalog {
    private static final List<VerifiedPlace> PLACES = List.of(
            ...
            new VerifiedPlace("강릉", "식당", "강릉중앙시장 먹거리", "강원 강릉시 금성로 21", "닭강정, 수산 먹거리, 감자전", "강릉 도심 대표 전통시장 먹거리 동선", "LocalTrip verified"),
            new VerifiedPlace("강릉", "식당", "초당두부마을", "강원 강릉시 초당순두부길 일대", "초당순두부, 두부전골", "강릉 초당권 대표 식사 밀집 지역", "LocalTrip verified"),
            new VerifiedPlace("강릉", "카페", "안목커피거리", "강원 강릉시 창해로14번길 일대", "커피, 베이커리", "바다 전망 카페가 밀집한 강릉 대표 카페 거리", "LocalTrip verified"),
            new VerifiedPlace("강릉", "카페", "테라로사 커피공장 강릉본점", "강원 강릉시 구정면 현천길 25", "핸드드립, 커피, 베이커리", "강릉에서 실제 운영되는 대표 로스터리 카페", "LocalTrip verified"),
